...
const plans: {
...
}[] = [
  {
    ...
    name: "Pay per song",
    price: "From $2.99",
    description: "Buy listening rooms one at a time. Own them in your library.",
    cta: "Explore Rooms",
    href: "/music",
    highlight: false,
    features: [
  ...
  },
  {
    ...
    price: "$9.99/mo",
    description: "Stream every room. Cancel anytime.",
  ...
  },
  {
    ...
    price: "$99/yr",
    description: "Every room for a year plus a free Silk Sleep Mask.",
